...
Nuts.prototype.onUpdate = function(req, res, next) {
    ...
    .then(function() {
        ...
        // than this one has to upgrade to this and upgrade to the latest from here.
        // Original idea from here:
        // https://github.com/Squirrel/Squirrel.Mac/issues/160#issuecomment-171545819
        // TODO: Make it configurable, multiple pivots, support Windows too
        var pivotVersion = '1.3.0';
        if (semver.lt(tag, pivotVersion)) {
            // This should always find the pivot version
